function cnn = cnn_initial(cnn, nLabel)
nInput = 1;
...
cnn.weight_index = reshape(1:nOutput*nLabel, nLabel, nOutput) + fore_index;
fore_index = fore_index + nOutput*nLabel;
cnn.bias_index = (1:nLabel)' + fore_index;
