...
%% CNN structure
% cnn.layers={
%         struct('type', 'i')                                                             % 11-by-11
%         struct('type', 'c', 'nFilter', 1, 'filtersize', [2, 2])         % 10-by-10
%         struct('type', 'p', 'stride', [2, 2]);                                % 5-by-5
%         struct('type', 'c', 'nFilter', 1, 'filtersize', [2, 2])         % 4-by-4
%         struct('type', 'p', 'stride', [2, 2]);                                % 2-by-2
%         };
